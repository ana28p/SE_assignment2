...
class GraphViewer extends JFrame {
    ...
    private void initMenu() {
        ...
        miOpenG.addActionListener(new ActionListener() {
        ...
        miOpenS.addActionListener(new ActionListener() {
        ...
        miSaveG.addActionListener(new ActionListener() {
        ...
        miSaveGAs.addActionListener(new ActionListener() {
        ...
        miSaveS.addActionListener(new ActionListener() {
        ...
        miSaveSAs.addActionListener(new ActionListener() {
    ...
    private void ExitViewer() {
        if (JOptionPane.showConfirmDialog(getContentPane(), "�� �������, ��� ������ �����?") == JOptionPane.YES_OPTION) System.exit(0);
    }
